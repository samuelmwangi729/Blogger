...
const {Index,ProfileController,getProfileData,VerifyAccount,Categories,getVerificationToken,getLocalVerificationDetails,getUploadedCategories,GetSubCategories,PropagateEvent} = require('../Controller/AuthenticatedController')
...
.post("/Verify/Account/Local",getLocalVerificationDetails)
